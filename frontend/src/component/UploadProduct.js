    ...
    <div className="fixed w-full  h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center">
      <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
        <div className="flex justify-between items-center pb-3">
          ...
          <div
            className="w-fil ml-auto text-2xl font-bold hover:text-red-700 cursor-pointer"
            onClick={onClose}
          >
            <CgClose />
          </div>
        ...
        <form className="grid p-4 gap-2 overflow-y-scroll h-full pb-5" onSubmit={handleSubmit}>
          ...
          <label htmlFor="uploadImageInput">
            <div className="p-2 bg-slate-100 border rounded h-32 w-full flex items-center justify-center cursor-pointer">
              <div className="bg-slate-100 flex items-center justify-center flex-col gap-2">
